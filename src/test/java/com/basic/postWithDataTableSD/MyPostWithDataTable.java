...
public class MyPostWithDataTable {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("C:\\Radical\\B17CuCuRestAssured\\src\\test\\java\\com\\basic\\postFromTextFileSD\\user.json"))); 
